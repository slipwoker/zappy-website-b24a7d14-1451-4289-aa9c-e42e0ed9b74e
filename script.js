document.addEventListener('DOMContentLoaded', function() {
  ...
  if (contactForm) {
    ...
    const validators = {
      ...
      tel: (value) => {
        if (value.trim() && !/^[+\d\s\-()]{7,}$/.test(value)) return 'Please enter a valid phone number';
        return null;
      },
      text: (value) => {
      ...
      if (isValid) {
        ...
        .then(response => {
          if (response.ok) {
            ...
            success.style.cssText = 'color:#38a169;margin-top:1rem;';
        ...
        .catch(() => {
          ...
          error.className = 'form-error-global';
          error.style.cssText = 'color:#e53e3e;margin-top:1rem;';
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: 'b24a7d14-1451-4289-aa9c-e42e0ed9b74e',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || 'b24a7d14-1451-4289-aa9c-e42e0ed9b74e';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = 'b24a7d14-1451-4289-aa9c-e42e0ed9b74e';
